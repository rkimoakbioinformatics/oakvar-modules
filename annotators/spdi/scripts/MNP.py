...
class MNP(Variant):
    ...
    """
    A class representing a Multi nucleotide polymorphism (MNP).
    """
    ...
    def _left_align(self):
        raise NotImplementedError("Left alignment not applicable for MNP")

    def _get_left_context(self):
        raise NotImplementedError("Getting left context not applicable for MNP")

    def _get_right_context(self):
        raise NotImplementedError("Getting right context not applicable for MNP")

    def _construct_contextual_allele(self):
        raise NotImplementedError("Constructing contextual allele not applicable for MNP")